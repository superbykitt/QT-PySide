...
from PySide6.QtGui import QBrush, QColor, QPen, QPainterPath, QPainter, QPolygonF, QFont
from PySide6.QtCore import Qt, QLine, QRectF, QPointF
import PySide6
import math
...
class VisualGraphScene(QGraphicsScene):
    ...
    def __init__(self,parent=None):
        ...
        self._hight = EditorConfig.editor_scene_height
        self._grid_size = EditorConfig.editor_scene_grid_size
        self._chunk_size = EditorConfig.editor_scene_grid_chunk

        self.setSceneRect(self._width / 2, self._hight / 2, self._width, self._hight)
    ...
    def cal_grid_lines(self, rect):
        left, right, top, bottom = math.floor(rect.left()), \
